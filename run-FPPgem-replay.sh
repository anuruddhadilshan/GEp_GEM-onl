...
# This script will take the required arguments and run the replay script 'replay_gep_FPPGEM.C'.
...
analyzer -b -q 'replay_gep_FPPGEM.C+('$runnum', '$maxevents', '$firstevent', '\"$prefix\"', '$firstsegment', '$maxsegments', '$pedestalmode')'
